...
RUN pwsh /app/release.ps1 -mark_released -create_tag -version 100
RUN pwsh /app/assertOutput.ps1 "pwsh /app/release.ps1 -mark_released -create_tag -version 100.1" "Backmerge required, please open: /git-upstream/.git/compare/master?expand=1&title=Backmerge+from+master+to+develop Backmerge required for release-101, please open: /git-upstream/.git/compare/release-101...master?expand=1&title=Backmerge+from+master+to+release-101" -assertPass -assertPartialMatch
